...
export function arraylistGradient() {
    ...
    for (let i = 0; i < modules.length; i++) {
        ...
        element.style.color = `rgba( ${rgb.r}, ${rgb.g}, ${rgb.b},0.8)`;
        element.style.textShadow = `0 0 2px rgb(${rgb.r}, ${rgb.g}, ${rgb.b})`;
        element.style.filter = `drop-shadow(0 0 4px rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, 0.1))`;
        element.style.backgroundImage = `
        linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)),
        linear-gradient(rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, 0.2), rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, 0.2))
      `;
      ...
      const sidebar = element.querySelector(".side-bar") as HTMLElement;
      if (sidebar) {
          sidebar.style.backgroundColor = `rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, 1)`;
          sidebar.style.boxShadow = `0 0 6px rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, 0.8)`;
      }
